...
import os
import torch
from PatchTST.PatchTST_supervised.exp.exp_main import Exp_Main
import random
import numpy as np
...
if __name__ == '__main__':
    ...
    parser.add_argument('--feature_cols', type=list[str], default=['TEMPERATURE'], help='input features')
    ...
    parser.add_argument('--scale', action='store_false', help='whether to scale the data', default=False)
    parser.add_argument('--checkpoints', type=str, default='./checkpoints/', help='location of model checkpoints')

    # forecasting task
    parser.add_argument('--seq_len', type=int, default=96, help='input sequence length') # for PatchTST, it is the total context window length
    ...
    parser.add_argument('--pred_len', type=int, default=96, help='prediction sequence length') # for PatchTST, it is the target window length AKA forecasting horizon
    ...
    parser.add_argument('--enc_in', type=int, default=2, help='encoder input size') # Use this hyperparameter as the number of channels
